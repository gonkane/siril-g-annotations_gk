        ...
        try:
            ...
            with self.siril.image_lock():
                ...
                per_object_label_overrides=self.object_label_mode_overrides,
                 ...
                 per_object_font_overrides=self.object_font_overrides,# 標本設定
...
# Silent WCS check using FITS header (avoid console logs)
            ...
            per_object_label_overrides=self.object_label_mode_overrides,
                 ...
                 per_object_font_overrides=self.object_font_overrides,table_max_per_page=(25 if self.specimen_use_defaults else int(self.specimen_max_per_page)),
